...
parser.add_argument('--model-path',
                    ...
                    # default='/media/jiefei/Guji Mind1/Guji_Projects/Checkpoints/GN_008/WideResNet_128_0_100_Adam_sdlog008d_184_GN.pth',
...
def cw_whitebox(model, device, test_loader):
    ...
    filename = "/media/jiefei/Guji Mind1/Guji_Projects/rs/AWP_GN_clean.txt"
    ...
    for data, target in test_loader:
        ...
        # attack = torchattacks.PGD(model, eps=8./255., alpha=0.8/255., steps=20, random_start=True)
